...
This should give a response of status 200 meaning that everything has gone on well or requests could fetch the web-page at the url without any sort of trouble.
